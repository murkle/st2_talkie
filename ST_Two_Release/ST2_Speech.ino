...
ISR(TIMER0_COMPA_vect) {
  ...
  int16_t u0,u1,u2,u3,u4,u5,u6,u7,u8,u9,u10;
    ...
    OCR1A = nextPwm; OCR1B = nextPwm ^ 255;
  if (synthPeriod) {
    // Voiced source
